...
export const EduTemp = ({ addResumeForm, resumeFormFields, onAdd, onDlt }) => {
    ...
    const eduFields = {
        "school" : addResumeForm.getGeneralFieldObj([addResumeForm.validators.required]),
        "degree": addResumeForm.getGeneralFieldObj([addResumeForm.validators.required]),
        ...
        "grade": addResumeForm.getGeneralFieldObj([addResumeForm.validators.required])
    }
